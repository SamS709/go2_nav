...
All the environments are registered in the `go2_nav` extension. They start
...
import go2_nav.tasks  # noqa: F401


def main():
    """Print all environments registered in `go2_nav` extension."""
