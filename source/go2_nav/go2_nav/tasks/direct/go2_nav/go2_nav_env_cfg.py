...
class Go2NavEnvCfg(DirectRLEnvCfg):
    ...
    terrain: TerrainImporterCfg = TerrainImporterCfg(
        ...
        terrain_generator=make_maze_terrain_cfg(
            ...
            wall_height_range=(2.0, 3.0),
            wall_thickness_range=(0.1, 0.5),
            floor_thickness=0.06,
            algorithm="dfs",
            seed=42,
            stairs_prob_range=(0.2, 0.25),
            boxes_prob_range=(0.2, 0.25),
            rough_prob_range=(0.2, 0.25),
            ...
            boxes_patch_size_ratio_range=(1.0, 2.0),
            rough_n_rough_range=(16, 36),
            rough_h_rough_z_range=(0.01, 0.15),
            rough_h_rough_xy_range=(0.4, 0.8),
            rough_patch_size_ratio_range=(1.0, 2.0),
        ),
        collision_group=-1,
        physics_material=sim_utils.RigidBodyMaterialCfg(
            friction_combine_mode="multiply",
